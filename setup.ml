...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5bf24de7425183b807b606aac770a93e) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Event_clock"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-event-clock";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "mirage-event-clock";
                           FindlibPackage ("duration", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "B\226\1290\017G\226\tt\018\198\178\176\200\253i";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
